...
| **Arabic (ar-LB)**  | `ShamiPhonemizer`      | [hams-levantine-tts](https://github.com/Al-aminI/hams-levantine-tts)                                               | IPA                          | Levantine Arabic / English code-switching front-end for ShamiVITS; emits per-phoneme language IDs.                                          |
...
- [Al-aminI/hams-levantine-tts](https://github.com/Al-aminI/hams-levantine-tts) for the Shami (Levantine Arabic / English) text front-end

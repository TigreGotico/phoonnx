"""Torch ``LightningModule`` for the StyleTTS2 training engine.

Split out of :mod:`phoonnx_train.engines.styletts2` so the engine module — and
therefore the training registry — imports torch-free; the heavy torch /
pytorch_lightning class (the full two-stage yl4579 port) lives here and is
imported lazily when a model is actually built. See the engine module for the
recipe, quality presets and citation notes.
"""

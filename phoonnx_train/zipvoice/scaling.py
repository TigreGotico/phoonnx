"""Scaled / balanced neural-network modules for Zipformer training.

The activation-balancing, whitening and Swoosh activation modules from the
Zipformer architecture (Yao et al., "Zipformer: A faster and better encoder
for automatic speech recognition", ICLR 2024, arXiv:2310.11230) that keep
very deep Zipformer stacks trainable. Ported from k2-fsa/ZipVoice
(Apache-2.0).
"""

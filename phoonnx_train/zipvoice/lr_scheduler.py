"""Eden learning-rate schedule used by the ZipVoice recipe.

Eden decays the learning rate with both batch count and epoch count
(``lr_batches``, ``lr_epochs``) and warms up over the first batches; it is
the schedule paired with ScaledAdam in the Zipformer line of work
(Yao et al., "Zipformer: A faster and better encoder for automatic speech
recognition", ICLR 2024, arXiv:2310.11230) and in ZipVoice
(Zhu et al., arXiv:2506.13053). Ported from k2-fsa/ZipVoice (Apache-2.0).
"""

...
Integrates the learned vector field from noise (t=0) to data (t=1) with a
small number of Euler steps, with classifier-free guidance folding, as in
ZipVoice (Zhu et al., arXiv:2506.13053). Ported from k2-fsa/ZipVoice
(Apache-2.0).
"""

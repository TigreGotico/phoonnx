...
The U-Net-style downsampled transformer encoder of Yao et al., "Zipformer:
A faster and better encoder for automatic speech recognition", ICLR 2024
(arXiv:2310.11230), in its TTS configuration (``TTSZipformer``) used by
ZipVoice (Zhu et al., arXiv:2506.13053) for both the text encoder and the
flow-matching decoder. Ported from k2-fsa/ZipVoice (Apache-2.0).
"""

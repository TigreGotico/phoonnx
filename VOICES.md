...
| :--- | :--- | :--- | :--- |
| `facebook/mms-tts-abi-Abidji` | `abi` | `transformers` | `unicode` |
| `facebook/mms-tts-abp-Ayta, Abellen` | `abp` | `transformers` | `unicode` |
| `facebook/mms-tts-aca-Achagua` | `aca` | `transformers` | `unicode` |
| `facebook/mms-tts-acd-Gikyode` | `acd` | `transformers` | `unicode` |
| `facebook/mms-tts-ace-Aceh` | `ace` | `transformers` | `unicode` |
| `facebook/mms-tts-acf-Lesser Antillean French Creole` | `acf` | `transformers` | `unicode` |
| `facebook/mms-tts-ach-Acholi` | `ach` | `transformers` | `unicode` |
| `facebook/mms-tts-acn-Achang` | `acn` | `transformers` | `unicode` |
| `facebook/mms-tts-acr-Achi` | `acr` | `transformers` | `unicode` |
| `facebook/mms-tts-acu-Achuar-Shiwiar` | `acu` | `transformers` | `unicode` |
| `facebook/mms-tts-ade-Adele` | `ade` | `transformers` | `unicode` |
| `facebook/mms-tts-adh-Jopadhola` | `adh` | `transformers` | `unicode` |
| `facebook/mms-tts-adj-Adioukrou` | `adj` | `transformers` | `unicode` |
| `facebook/mms-tts-adx-Tibetan, Amdo` | `adx` | `transformers` | `unicode` |
| `facebook/mms-tts-aeu-Akeu` | `aeu` | `transformers` | `unicode` |
| `mimic3/af_ZA/google-nwu_low` | `af-ZA` | `mimic3` | `espeak` |
| `facebook/mms-tts-agd-Agarabi` | `agd` | `transformers` | `unicode` |
| `facebook/mms-tts-agg-Angor` | `agg` | `transformers` | `unicode` |
| `facebook/mms-tts-agn-Agutaynen` | `agn` | `transformers` | `unicode` |
| `facebook/mms-tts-agr-Awajún` | `agr` | `transformers` | `unicode` |
| `facebook/mms-tts-agu-Awakateko` | `agu` | `transformers` | `unicode` |
| `facebook/mms-tts-agx-Aghul` | `agx` | `transformers` | `unicode` |
...
| `facebook/mms-tts-alj-Alangan` | `alj` | `transformers` | `unicode` |
...
| `facebook/mms-tts-any-Anyin` | `any` | `transformers` | `unicode` |
...
| `facebook/mms-tts-awb-Awa` | `awb` | `transformers` | `unicode` |
| `facebook/mms-tts-ayo-Ayoreo` | `ayo` | `transformers` | `unicode` |
| `facebook/mms-tts-ayr-Aymara, Central` | `ayr` | `transformers` | `unicode` |
...
| `facebook/mms-tts-bba-Baatonum` | `bba` | `transformers` | `unicode` |
...
| `facebook/mms-tts-bdh-Baka` | `bdh` | `transformers` | `unicode` |
| `facebook/mms-tts-bdq-Bahnar` | `bdq` | `transformers` | `unicode` |
| `facebook/mms-tts-bdu-Oroko` | `bdu` | `transformers` | `unicode` |
...
| `facebook/mms-tts-bgr-Chin, Bawm` | `bgr` | `transformers` | `unicode` |
| `facebook/mms-tts-bgt-Bughotu` | `bgt` | `transformers` | `unicode` |
| `facebook/mms-tts-bgw-Bhatri` | `bgw` | `transformers` | `unicode` |
...
| `facebook/mms-tts-bjw-Bakwé` | `bjw` | `transformers` | `unicode` |
| `facebook/mms-tts-bjz-Baruga` | `bjz` | `transformers` | `unicode` |
| `facebook/mms-tts-bkd-Binukid` | `bkd` | `transformers` | `unicode` |
| `facebook/mms-tts-bkv-Bekwarra` | `bkv` | `transformers` | `unicode` |
| `facebook/mms-tts-blh-Kuwaa` | `blh` | `transformers` | `unicode` |
...
| `facebook/mms-tts-bov-Tuwuli` | `bov` | `transformers` | `unicode` |
| `facebook/mms-tts-box-Buamu` | `box` | `transformers` | `unicode` |
| `facebook/mms-tts-bpr-Blaan, Koronadal` | `bpr` | `transformers` | `unicode` |
| `facebook/mms-tts-bps-Blaan, Sarangani` | `bps` | `transformers` | `unicode` |
| `facebook/mms-tts-bqc-Boko` | `bqc` | `transformers` | `unicode` |
| `facebook/mms-tts-bqi-Bakhtiâri` | `bqi` | `transformers` | `unicode` |
| `facebook/mms-tts-bqj-Bandial` | `bqj` | `transformers` | `unicode` |
| `facebook/mms-tts-bqp-Bisã` | `bqp` | `transformers` | `unicode` |
| `facebook/mms-tts-bru-Bru, Eastern` | `bru` | `transformers` | `unicode` |
| `facebook/mms-tts-bsc-Oniyan` | `bsc` | `transformers` | `unicode` |
| `facebook/mms-tts-bsq-Bassa` | `bsq` | `transformers` | `unicode` |
| `facebook/mms-tts-bss-Akoose` | `bss` | `transformers` | `unicode` |
| `facebook/mms-tts-btd-Batak Dairi` | `btd` | `transformers` | `unicode` |
| `facebook/mms-tts-bts-Batak Simalungun` | `bts` | `transformers` | `unicode` |
...
| `facebook/mms-tts-bwq-Bobo Madaré, Southern` | `bwq` | `transformers` | `unicode` |
| `facebook/mms-tts-bwu-Buli` | `bwu` | `transformers` | `unicode` |
| `facebook/mms-tts-byr-Yipma` | `byr` | `transformers` | `unicode` |
...
| `facebook/mms-tts-cbr-Kakataibo-Kashibo` | `cbr` | `transformers` | `unicode` |
| `facebook/mms-tts-cbs-Kashinawa` | `cbs` | `transformers` | `unicode` |
| `facebook/mms-tts-cbt-Shawi` | `cbt` | `transformers` | `unicode` |
| `facebook/mms-tts-cbu-Kandozi-Chapra` | `cbu` | `transformers` | `unicode` |
| `facebook/mms-tts-cbv-Cacua` | `cbv` | `transformers` | `unicode` |
...
| `facebook/mms-tts-cjs-Shor` | `cjs` | `transformers` | `unicode` |
| `facebook/mms-tts-cko-Anufo` | `cko` | `transformers` | `unicode` |
| `facebook/mms-tts-ckt-Chukchi` | `ckt` | `transformers` | `unicode` |
| `facebook/mms-tts-cla-Ron` | `cla` | `transformers` | `unicode` |
...
| `facebook/mms-tts-cnl-Chinantec, Lalana` | `cnl` | `transformers` | `unicode` |
| `facebook/mms-tts-cnt-Chinantec, Tepetotutla` | `cnt` | `transformers` | `unicode` |
| `facebook/mms-tts-coe-Koreguaje` | `coe` | `transformers` | `unicode` |
| `facebook/mms-tts-cof-Tsafiki` | `cof` | `transformers` | `unicode` |
| `facebook/mms-tts-cok-Cora, Santa Teresa` | `cok` | `transformers` | `unicode` |
| `facebook/mms-tts-con-Cofán` | `con` | `transformers` | `unicode` |
| `facebook/mms-tts-cot-Caquinte` | `cot` | `transformers` | `unicode` |
| `facebook/mms-tts-cou-Wamey` | `cou` | `transformers` | `unicode` |
| `facebook/mms-tts-cpa-Chinantec, Palantla` | `cpa` | `transformers` | `unicode` |
...
| `facebook/mms-tts-crs-Seychelles French Creole` | `crs` | `transformers` | `unicode` |
| `facebook/mms-tts-crt-Chorote, Iyojwa’ja` | `crt` | `transformers` | `unicode` |
...
| `facebook/mms-tts-csk-Jola-Kasa` | `csk` | `transformers` | `unicode` |
| `facebook/mms-tts-cso-Chinantec, Sochiapam` | `cso` | `transformers` | `unicode` |
| `facebook/mms-tts-ctd-Chin, Tedim` | `ctd` | `transformers` | `unicode` |
| `facebook/mms-tts-ctg-Chittagonian` | `ctg` | `transformers` | `unicode` |
| `facebook/mms-tts-cto-Embera Catío` | `cto` | `transformers` | `unicode` |
| `facebook/mms-tts-ctu-Chol` | `ctu` | `transformers` | `unicode` |
| `facebook/mms-tts-cuc-Chinantec, Usila` | `cuc` | `transformers` | `unicode` |
...
| `facebook/mms-tts-dah-Gwahatike` | `dah` | `transformers` | `unicode` |
| `facebook/mms-tts-dar-Dargwa` | `dar` | `transformers` | `unicode` |
...
| `facebook/mms-tts-dgo-Dogri` | `dgo` | `transformers` | `unicode` |
| `facebook/mms-tts-dgr-Tlicho` | `dgr` | `transformers` | `unicode` |
| `facebook/mms-tts-dhi-Dhimal` | `dhi` | `transformers` | `unicode` |
| `facebook/mms-tts-did-Didinga` | `did` | `transformers` | `unicode` |
...
| `facebook/mms-tts-dnt-Dani, Mid Grand Valley` | `dnt` | `transformers` | `unicode` |
| `facebook/mms-tts-dnw-Dani, Western` | `dnw` | `transformers` | `unicode` |
| `facebook/mms-tts-dop-Lukpa` | `dop` | `transformers` | `unicode` |
| `facebook/mms-tts-dos-Dogosé` | `dos` | `transformers` | `unicode` |
| `facebook/mms-tts-dsh-Daasanach` | `dsh` | `transformers` | `unicode` |
| `facebook/mms-tts-dso-Desiya` | `dso` | `transformers` | `unicode` |
...
| `hf_community/kakao-enterprise/vits-ljs-eng` | `en-US` | `transformers` | `unicode` |
...
| `hf_community/ylacombe/mms-spa-finetuned-chilean-monospeaker` | `es-CL` | `transformers` | `unicode` |
| `hf_community/ylacombe/mms-spa-finetuned-colombian-monospeaker` | `es-CO` | `transformers` | `unicode` |
...
| `facebook/mms-tts-gbi-Galela` | `gbi` | `transformers` | `unicode` |
| `facebook/mms-tts-gbk-Gaddi` | `gbk` | `transformers` | `unicode` |
| `facebook/mms-tts-gbm-Garhwali` | `gbm` | `transformers` | `unicode` |
| `facebook/mms-tts-gbo-Grebo, Northern` | `gbo` | `transformers` | `unicode` |
| `facebook/mms-tts-gde-Gude` | `gde` | `transformers` | `unicode` |
| `facebook/mms-tts-geb-Kire` | `geb` | `transformers` | `unicode` |
| `facebook/mms-tts-gej-Gen` | `gej` | `transformers` | `unicode` |
| `facebook/mms-tts-gil-Kiribati` | `gil` | `transformers` | `unicode` |
| `facebook/mms-tts-gjn-Gonja` | `gjn` | `transformers` | `unicode` |
| `facebook/mms-tts-gkn-Gokana` | `gkn` | `transformers` | `unicode` |
...
| `facebook/mms-tts-guq-Aché` | `guq` | `transformers` | `unicode` |
| `facebook/mms-tts-guu-Yanomamö` | `guu` | `transformers` | `unicode` |
| `facebook/mms-tts-gux-Gourmanchéma` | `gux` | `transformers` | `unicode` |
| `facebook/mms-tts-gvc-Wanano` | `gvc` | `transformers` | `unicode` |
| `facebook/mms-tts-gvl-Gulay` | `gvl` | `transformers` | `unicode` |
| `facebook/mms-tts-gwi-Gwich’in` | `gwi` | `transformers` | `unicode` |
...
| `facebook/mms-tts-hnn-Hanunoo` | `hnn` | `transformers` | `unicode` |
...
| `facebook/mms-tts-huv-Huave, San Mateo del Mar` | `huv` | `transformers` | `unicode` |
| `facebook/mms-tts-hvn-Hawu` | `hvn` | `transformers` | `unicode` |
| `facebook/mms-tts-hwc-Hawaii Pidgin` | `hwc` | `transformers` | `unicode` |
...
| `facebook/mms-tts-ifa-Ifugao, Amganad` | `ifa` | `transformers` | `unicode` |
| `facebook/mms-tts-ifb-Ifugao, Batad` | `ifb` | `transformers` | `unicode` |
| `facebook/mms-tts-ife-Ifè` | `ife` | `transformers` | `unicode` |
| `facebook/mms-tts-ifk-Ifugao, Tuwali` | `ifk` | `transformers` | `unicode` |
| `facebook/mms-tts-ifu-Ifugao, Mayoyao` | `ifu` | `transformers` | `unicode` |
| `facebook/mms-tts-ify-Kallahan, Keley-i` | `ify` | `transformers` | `unicode` |
| `facebook/mms-tts-ign-Ignaciano` | `ign` | `transformers` | `unicode` |
| `facebook/mms-tts-ikk-Ika` | `ikk` | `transformers` | `unicode` |
| `facebook/mms-tts-ilb-Ila` | `ilb` | `transformers` | `unicode` |
...
| `facebook/mms-tts-itl-Itelmen` | `itl` | `transformers` | `unicode` |
| `facebook/mms-tts-itv-Itawit` | `itv` | `transformers` | `unicode` |
...
| `facebook/mms-tts-izr-Izere` | `izr` | `transformers` | `unicode` |
...
| `facebook/mms-tts-jiv-Shuar` | `jiv` | `transformers` | `unicode` |
| `facebook/mms-tts-jmc-Machame` | `jmc` | `transformers` | `unicode` |
...
| `facebook/mms-tts-kaa-Karakalpak` | `kaa` | `transformers` | `unicode` |
...
| `facebook/mms-tts-kbr-Kafa` | `kbr` | `transformers` | `unicode` |
| `facebook/mms-tts-kby-Kanuri, Manga` | `kby` | `transformers` | `unicode` |
| `facebook/mms-tts-kca-Khanty` | `kca` | `transformers` | `unicode` |
| `facebook/mms-tts-kcg-Tyap` | `kcg` | `transformers` | `unicode` |
| `facebook/mms-tts-kdc-Kutu` | `kdc` | `transformers` | `unicode` |
| `facebook/mms-tts-kde-Makonde` | `kde` | `transformers` | `unicode` |
| `facebook/mms-tts-kdh-Tem` | `kdh` | `transformers` | `unicode` |
| `facebook/mms-tts-kdi-Kumam` | `kdi` | `transformers` | `unicode` |
| `facebook/mms-tts-kdj-Ng’akarimojong` | `kdj` | `transformers` | `unicode` |
| `facebook/mms-tts-kdl-Tsikimba` | `kdl` | `transformers` | `unicode` |
| `facebook/mms-tts-kdn-Kunda` | `kdn` | `transformers` | `unicode` |
| `facebook/mms-tts-kdt-Kuay` | `kdt` | `transformers` | `unicode` |
| `facebook/mms-tts-kek-Q’eqchi’` | `kek` | `transformers` | `unicode` |
| `facebook/mms-tts-ken-Kenyang` | `ken` | `transformers` | `unicode` |
| `facebook/mms-tts-keo-Kakwa` | `keo` | `transformers` | `unicode` |
| `facebook/mms-tts-ker-Kera` | `ker` | `transformers` | `unicode` |
...
| `facebook/mms-tts-kki-Kagulu` | `kki` | `transformers` | `unicode` |
| `facebook/mms-tts-kkj-Kako` | `kkj` | `transformers` | `unicode` |
| `facebook/mms-tts-kle-Kulung` | `kle` | `transformers` | `unicode` |
...
| `facebook/mms-tts-kpy-Koryak` | `kpy` | `transformers` | `unicode` |
| `facebook/mms-tts-kpz-Kupsapiiny` | `kpz` | `transformers` | `unicode` |
| `facebook/mms-tts-kqe-Kalagan` | `kqe` | `transformers` | `unicode` |
| `facebook/mms-tts-kqp-Kimré` | `kqp` | `transformers` | `unicode` |
| `facebook/mms-tts-kqr-Kimaragang` | `kqr` | `transformers` | `unicode` |
| `facebook/mms-tts-kqy-Koorete` | `kqy` | `transformers` | `unicode` |
| `facebook/mms-tts-krc-Karachay-Balkar` | `krc` | `transformers` | `unicode` |
| `facebook/mms-tts-kri-Krio` | `kri` | `transformers` | `unicode` |
| `facebook/mms-tts-krj-Kinaray-a` | `krj` | `transformers` | `unicode` |
| `facebook/mms-tts-krl-Karelian` | `krl` | `transformers` | `unicode` |
| `facebook/mms-tts-krr-Krung` | `krr` | `transformers` | `unicode` |
| `facebook/mms-tts-krs-Gbaya` | `krs` | `transformers` | `unicode` |
| `facebook/mms-tts-kru-Kurux` | `kru` | `transformers` | `unicode` |
| `facebook/mms-tts-ksb-Shambala` | `ksb` | `transformers` | `unicode` |
| `facebook/mms-tts-ksr-Borong` | `ksr` | `transformers` | `unicode` |
| `facebook/mms-tts-kss-Kisi, Southern` | `kss` | `transformers` | `unicode` |
| `facebook/mms-tts-ktb-Kambaata` | `ktb` | `transformers` | `unicode` |
| `facebook/mms-tts-ktj-Krumen, Plapo` | `ktj` | `transformers` | `unicode` |
| `facebook/mms-tts-kub-Kutep` | `kub` | `transformers` | `unicode` |
| `facebook/mms-tts-kue-Kuman` | `kue` | `transformers` | `unicode` |
| `facebook/mms-tts-kum-Kumyk` | `kum` | `transformers` | `unicode` |
| `facebook/mms-tts-kus-Kusaal` | `kus` | `transformers` | `unicode` |
| `facebook/mms-tts-kvn-Kuna, Border` | `kvn` | `transformers` | `unicode` |
| `facebook/mms-tts-kvw-Wersing` | `kvw` | `transformers` | `unicode` |
| `facebook/mms-tts-kwd-Kwaio` | `kwd` | `transformers` | `unicode` |
| `facebook/mms-tts-kwf-Kwara’ae` | `kwf` | `transformers` | `unicode` |
| `facebook/mms-tts-kwi-Awa-Cuaiquer` | `kwi` | `transformers` | `unicode` |
| `facebook/mms-tts-kxc-Konso` | `kxc` | `transformers` | `unicode` |
...
| `facebook/mms-tts-kyg-Keyagana` | `kyg` | `transformers` | `unicode` |
| `facebook/mms-tts-kyo-Klon` | `kyo` | `transformers` | `unicode` |
| `facebook/mms-tts-kyq-Kenga` | `kyq` | `transformers` | `unicode` |
...
| `facebook/mms-tts-lbj-Ladakhi` | `lbj` | `transformers` | `unicode` |
| `facebook/mms-tts-lbw-Tolaki` | `lbw` | `transformers` | `unicode` |
| `facebook/mms-tts-lcp-Lawa, Western` | `lcp` | `transformers` | `unicode` |
| `facebook/mms-tts-lee-Lyélé` | `lee` | `transformers` | `unicode` |
| `facebook/mms-tts-lef-Lelemi` | `lef` | `transformers` | `unicode` |
...
| `facebook/mms-tts-lia-Limba, West-Central` | `lia` | `transformers` | `unicode` |
| `facebook/mms-tts-lid-Nyindrou` | `lid` | `transformers` | `unicode` |
| `facebook/mms-tts-lif-Limbu` | `lif` | `transformers` | `unicode` |
| `facebook/mms-tts-lip-Sekpele` | `lip` | `transformers` | `unicode` |
| `facebook/mms-tts-lis-Lisu` | `lis` | `transformers` | `unicode` |
| `facebook/mms-tts-lje-Rampi` | `lje` | `transformers` | `unicode` |
| `facebook/mms-tts-ljp-Lampung Api` | `ljp` | `transformers` | `unicode` |
| `facebook/mms-tts-llg-Lole` | `llg` | `transformers` | `unicode` |
| `facebook/mms-tts-lln-Lele` | `lln` | `transformers` | `unicode` |
...
| `facebook/mms-tts-lon-Lomwe, Malawi` | `lon` | `transformers` | `unicode` |
| `facebook/mms-tts-loq-Lobala` | `loq` | `transformers` | `unicode` |
...
| `facebook/mms-tts-lww-Lewo` | `lww` | `transformers` | `unicode` |
| `facebook/mms-tts-lzz-Laz` | `lzz` | `transformers` | `unicode` |
...
| `facebook/mms-tts-mbc-Macushi` | `mbc` | `transformers` | `unicode` |
| `facebook/mms-tts-mbh-Mangseng` | `mbh` | `transformers` | `unicode` |
| `facebook/mms-tts-mbj-Nadëb` | `mbj` | `transformers` | `unicode` |
| `facebook/mms-tts-mbt-Manobo, Matigsalug` | `mbt` | `transformers` | `unicode` |
| `facebook/mms-tts-mbu-Mbula-Bwazza` | `mbu` | `transformers` | `unicode` |
| `facebook/mms-tts-mbz-Mixtec, Amoltepec` | `mbz` | `transformers` | `unicode` |
| `facebook/mms-tts-mca-Maka` | `mca` | `transformers` | `unicode` |
| `facebook/mms-tts-mcb-Matsigenka` | `mcb` | `transformers` | `unicode` |
| `facebook/mms-tts-mcd-Sharanahua` | `mcd` | `transformers` | `unicode` |
| `facebook/mms-tts-mco-Mixe, Coatlán` | `mco` | `transformers` | `unicode` |
| `facebook/mms-tts-mcp-Makaa` | `mcp` | `transformers` | `unicode` |
| `facebook/mms-tts-mcq-Ese` | `mcq` | `transformers` | `unicode` |
| `facebook/mms-tts-mcu-Mambila, Cameroon` | `mcu` | `transformers` | `unicode` |
| `facebook/mms-tts-mda-Mada` | `mda` | `transformers` | `unicode` |
| `facebook/mms-tts-mdv-Mixtec, Santa Lucía Monteverde` | `mdv` | `transformers` | `unicode` |
| `facebook/mms-tts-mdy-Male` | `mdy` | `transformers` | `unicode` |
| `facebook/mms-tts-med-Melpa` | `med` | `transformers` | `unicode` |
| `facebook/mms-tts-mee-Mengen` | `mee` | `transformers` | `unicode` |
| `facebook/mms-tts-mej-Meyah` | `mej` | `transformers` | `unicode` |
| `facebook/mms-tts-men-Mende` | `men` | `transformers` | `unicode` |
| `facebook/mms-tts-meq-Merey` | `meq` | `transformers` | `unicode` |
| `facebook/mms-tts-met-Mato` | `met` | `transformers` | `unicode` |
| `facebook/mms-tts-mev-Maan` | `mev` | `transformers` | `unicode` |
| `facebook/mms-tts-mfe-Morisyen` | `mfe` | `transformers` | `unicode` |
| `facebook/mms-tts-mfh-Matal` | `mfh` | `transformers` | `unicode` |
| `facebook/mms-tts-mfi-Wandala` | `mfi` | `transformers` | `unicode` |
| `facebook/mms-tts-mfk-Mofu, North` | `mfk` | `transformers` | `unicode` |
...
| `facebook/mms-tts-mhx-Lhao Vo` | `mhx` | `transformers` | `unicode` |
| `facebook/mms-tts-mhy-Ma’anyan` | `mhy` | `transformers` | `unicode` |
| `facebook/mms-tts-mib-Mixtec, Atatlahuca` | `mib` | `transformers` | `unicode` |
| `facebook/mms-tts-mie-Mixtec, Ocotepec` | `mie` | `transformers` | `unicode` |
| `facebook/mms-tts-mif-Mofu-Gudur` | `mif` | `transformers` | `unicode` |
| `facebook/mms-tts-mih-Mixtec, Chayuco` | `mih` | `transformers` | `unicode` |
| `facebook/mms-tts-mil-Mixtec, Peñoles` | `mil` | `transformers` | `unicode` |
| `facebook/mms-tts-mim-Mixtec, Alacatlatzala` | `mim` | `transformers` | `unicode` |
| `facebook/mms-tts-min-Minangkabau` | `min` | `transformers` | `unicode` |
| `facebook/mms-tts-mio-Mixtec, Pinotepa Nacional` | `mio` | `transformers` | `unicode` |
| `facebook/mms-tts-mip-Mixtec, Apasco-Apoala` | `mip` | `transformers` | `unicode` |
| `facebook/mms-tts-miq-Mískito` | `miq` | `transformers` | `unicode` |
| `facebook/mms-tts-mit-Mixtec, Southern Puebla` | `mit` | `transformers` | `unicode` |
| `facebook/mms-tts-miy-Mixtec, Ayutla` | `miy` | `transformers` | `unicode` |
| `facebook/mms-tts-miz-Mixtec, Coatzospan` | `miz` | `transformers` | `unicode` |
| `facebook/mms-tts-mjl-Mandeali` | `mjl` | `transformers` | `unicode` |
...
| `facebook/mms-tts-mnw-Mon` | `mnw` | `transformers` | `unicode` |
...
| `facebook/mms-tts-mox-Molima` | `mox` | `transformers` | `unicode` |
| `facebook/mms-tts-moz-Mukulu` | `moz` | `transformers` | `unicode` |
| `facebook/mms-tts-mpg-Marba` | `mpg` | `transformers` | `unicode` |
| `facebook/mms-tts-mpm-Mixtec, Yosondúa` | `mpm` | `transformers` | `unicode` |
| `facebook/mms-tts-mpp-Migabac` | `mpp` | `transformers` | `unicode` |
| `facebook/mms-tts-mpx-Misima-Panaeati` | `mpx` | `transformers` | `unicode` |
| `facebook/mms-tts-mqb-Mbuko` | `mqb` | `transformers` | `unicode` |
...
| `facebook/mms-tts-mtj-Moskona` | `mtj` | `transformers` | `unicode` |
| `facebook/mms-tts-mto-Mixe, Totontepec` | `mto` | `transformers` | `unicode` |
| `facebook/mms-tts-muh-Mündü` | `muh` | `transformers` | `unicode` |
| `facebook/mms-tts-mup-Malvi` | `mup` | `transformers` | `unicode` |
| `facebook/mms-tts-mur-Murle` | `mur` | `transformers` | `unicode` |
| `facebook/mms-tts-muv-Muthuvan` | `muv` | `transformers` | `unicode` |
| `facebook/mms-tts-muy-Muyang` | `muy` | `transformers` | `unicode` |
| `facebook/mms-tts-mvp-Duri` | `mvp` | `transformers` | `unicode` |
| `facebook/mms-tts-mwq-Chin, Müün` | `mwq` | `transformers` | `unicode` |
| `facebook/mms-tts-mwv-Mentawai` | `mwv` | `transformers` | `unicode` |
| `facebook/mms-tts-mxb-Mixtec, Tezoatlán` | `mxb` | `transformers` | `unicode` |
...
| `facebook/mms-tts-myv-Erzya` | `myv` | `transformers` | `unicode` |
| `facebook/mms-tts-myx-Masaaba` | `myx` | `transformers` | `unicode` |
| `facebook/mms-tts-myy-Macuna` | `myy` | `transformers` | `unicode` |
| `facebook/mms-tts-mza-Mixtec, Santa María Zacatepec` | `mza` | `transformers` | `unicode` |
| `facebook/mms-tts-mzi-Mazatec, Ixcatlán` | `mzi` | `transformers` | `unicode` |
| `facebook/mms-tts-mzj-Manya` | `mzj` | `transformers` | `unicode` |
| `facebook/mms-tts-mzk-Mambila, Nigeria` | `mzk` | `transformers` | `unicode` |
| `facebook/mms-tts-mzm-Mumuye` | `mzm` | `transformers` | `unicode` |
| `facebook/mms-tts-mzw-Deg` | `mzw` | `transformers` | `unicode` |
| `facebook/mms-tts-nab-Nambikuára, Southern` | `nab` | `transformers` | `unicode` |
| `facebook/mms-tts-nag-Nagamese` | `nag` | `transformers` | `unicode` |
| `facebook/mms-tts-nan-Chinese, Min Nan` | `nan` | `transformers` | `unicode` |
| `facebook/mms-tts-nas-Naasioi` | `nas` | `transformers` | `unicode` |
| `facebook/mms-tts-naw-Nawuri` | `naw` | `transformers` | `unicode` |
| `facebook/mms-tts-nca-Iyo` | `nca` | `transformers` | `unicode` |
| `facebook/mms-tts-nch-Nahuatl, Central Huasteca` | `nch` | `transformers` | `unicode` |
| `facebook/mms-tts-ncj-Nahuatl, Northern Puebla` | `ncj` | `transformers` | `unicode` |
| `facebook/mms-tts-ncl-Nahuatl, Michoacán` | `ncl` | `transformers` | `unicode` |
| `facebook/mms-tts-ncu-Chumburung` | `ncu` | `transformers` | `unicode` |
| `facebook/mms-tts-ndj-Ndamba` | `ndj` | `transformers` | `unicode` |
| `facebook/mms-tts-ndp-Kebu` | `ndp` | `transformers` | `unicode` |
| `facebook/mms-tts-ndv-Ndut` | `ndv` | `transformers` | `unicode` |
| `facebook/mms-tts-ndy-Lutos` | `ndy` | `transformers` | `unicode` |
| `facebook/mms-tts-ndz-Ndogo` | `ndz` | `transformers` | `unicode` |
...
| `facebook/mms-tts-neb-Toura` | `neb` | `transformers` | `unicode` |
| `facebook/mms-tts-new-Newar` | `new` | `transformers` | `unicode` |
| `facebook/mms-tts-nfa-Dhao` | `nfa` | `transformers` | `unicode` |
| `facebook/mms-tts-nfr-Nafaanra` | `nfr` | `transformers` | `unicode` |
| `facebook/mms-tts-nga-Ngbaka` | `nga` | `transformers` | `unicode` |
| `facebook/mms-tts-ngl-Lomwe` | `ngl` | `transformers` | `unicode` |
| `facebook/mms-tts-ngp-Ngulu` | `ngp` | `transformers` | `unicode` |
| `facebook/mms-tts-ngu-Nahuatl, Guerrero` | `ngu` | `transformers` | `unicode` |
| `facebook/mms-tts-nhe-Nahuatl, Eastern Huasteca` | `nhe` | `transformers` | `unicode` |
| `facebook/mms-tts-nhi-Nahuatl, Zacatlán-Ahuacatlán-Tepetzintla` | `nhi` | `transformers` | `unicode` |
| `facebook/mms-tts-nhu-Noone` | `nhu` | `transformers` | `unicode` |
| `facebook/mms-tts-nhw-Nahuatl, Western Huasteca` | `nhw` | `transformers` | `unicode` |
| `facebook/mms-tts-nhx-Nahuatl, Isthmus-Mecayapan` | `nhx` | `transformers` | `unicode` |
| `facebook/mms-tts-nhy-Nahuatl, Northern Oaxaca` | `nhy` | `transformers` | `unicode` |
| `facebook/mms-tts-nia-Nias` | `nia` | `transformers` | `unicode` |
| `facebook/mms-tts-nij-Ngaju` | `nij` | `transformers` | `unicode` |
...
| `facebook/mms-tts-nnb-Nande` | `nnb` | `transformers` | `unicode` |
| `facebook/mms-tts-nnq-Ngindo` | `nnq` | `transformers` | `unicode` |
| `facebook/mms-tts-nnw-Nuni, Southern` | `nnw` | `transformers` | `unicode` |
| `piper/no_NO-talesyntese-medium` | `no-NO` | `piper` | `espeak` |
| `facebook/mms-tts-noa-Woun Meu` | `noa` | `transformers` | `unicode` |
| `facebook/mms-tts-nod-Thai, Northern` | `nod` | `transformers` | `unicode` |
| `facebook/mms-tts-nog-Nogai` | `nog` | `transformers` | `unicode` |
| `facebook/mms-tts-not-Nomatsigenga` | `not` | `transformers` | `unicode` |
| `facebook/mms-tts-npl-Nahuatl, Southeastern Puebla` | `npl` | `transformers` | `unicode` |
| `facebook/mms-tts-npy-Napu` | `npy` | `transformers` | `unicode` |
| `facebook/mms-tts-nst-Naga, Tangshang` | `nst` | `transformers` | `unicode` |
| `facebook/mms-tts-nsu-Nahuatl, Sierra Negra` | `nsu` | `transformers` | `unicode` |
| `facebook/mms-tts-ntm-Nateni` | `ntm` | `transformers` | `unicode` |
| `facebook/mms-tts-ntr-Delo` | `ntr` | `transformers` | `unicode` |
| `facebook/mms-tts-nuj-Nyole` | `nuj` | `transformers` | `unicode` |
| `facebook/mms-tts-nus-Nuer` | `nus` | `transformers` | `unicode` |
...
| `facebook/mms-tts-pbb-Nasa` | `pbb` | `transformers` | `unicode` |
| `facebook/mms-tts-pbc-Patamona` | `pbc` | `transformers` | `unicode` |
| `facebook/mms-tts-pbi-Parkwa` | `pbi` | `transformers` | `unicode` |
| `facebook/mms-tts-pce-Palaung, Ruching` | `pce` | `transformers` | `unicode` |
| `facebook/mms-tts-pcm-Pidgin, Nigerian` | `pcm` | `transformers` | `unicode` |
| `facebook/mms-tts-peg-Pengo` | `peg` | `transformers` | `unicode` |
| `facebook/mms-tts-pez-Penan, Eastern` | `pez` | `transformers` | `unicode` |
| `facebook/mms-tts-pib-Yine` | `pib` | `transformers` | `unicode` |
| `facebook/mms-tts-pil-Yom` | `pil` | `transformers` | `unicode` |
| `facebook/mms-tts-pir-Piratapuyo` | `pir` | `transformers` | `unicode` |
...
| `facebook/mms-tts-pls-Popoloca, San Marcos Tlacoyalco` | `pls` | `transformers` | `unicode` |
...
| `facebook/mms-tts-prf-Paranan` | `prf` | `transformers` | `unicode` |
| `facebook/mms-tts-prk-Wa, Parauk` | `prk` | `transformers` | `unicode` |
...
| `facebook/mms-tts-ptu-Bambam` | `ptu` | `transformers` | `unicode` |
| `facebook/mms-tts-pui-Puinave` | `pui` | `transformers` | `unicode` |
| `facebook/mms-tts-pwg-Gapapaiwa` | `pwg` | `transformers` | `unicode` |
...
| `facebook/mms-tts-quw-Quichua, Tena Lowland` | `quw` | `transformers` | `unicode` |
| `facebook/mms-tts-quy-Quechua, Ayacucho` | `quy` | `transformers` | `unicode` |
| `facebook/mms-tts-quz-Quechua, Cusco` | `quz` | `transformers` | `unicode` |
| `facebook/mms-tts-qvc-Quechua, Cajamarca` | `qvc` | `transformers` | `unicode` |
| `facebook/mms-tts-qve-Quechua, Eastern Apurímac` | `qve` | `transformers` | `unicode` |
| `facebook/mms-tts-qvh-Quechua, Huamalíes-Dos de Mayo Huánuco` | `qvh` | `transformers` | `unicode` |
| `facebook/mms-tts-qvm-Quechua, Margos-Yarowilca-Lauricocha` | `qvm` | `transformers` | `unicode` |
| `facebook/mms-tts-qvn-Quechua, North Junín` | `qvn` | `transformers` | `unicode` |
| `facebook/mms-tts-qvo-Quichua, Napo` | `qvo` | `transformers` | `unicode` |
| `facebook/mms-tts-qvs-Quechua, San Martín` | `qvs` | `transformers` | `unicode` |
| `facebook/mms-tts-qvw-Quechua, Huaylla Wanca` | `qvw` | `transformers` | `unicode` |
| `facebook/mms-tts-qvz-Quichua, Northern Pastaza` | `qvz` | `transformers` | `unicode` |
| `facebook/mms-tts-qwh-Quechua, Huaylas Ancash` | `qwh` | `transformers` | `unicode` |
| `facebook/mms-tts-qxh-Quechua, Panao` | `qxh` | `transformers` | `unicode` |
| `facebook/mms-tts-qxl-Quichua, Salasaca Highland` | `qxl` | `transformers` | `unicode` |
| `facebook/mms-tts-qxn-Quechua, Northern Conchucos Ancash` | `qxn` | `transformers` | `unicode` |
| `facebook/mms-tts-qxo-Quechua, Southern Conchucos` | `qxo` | `transformers` | `unicode` |
| `facebook/mms-tts-qxr-Quichua, Cañar Highland` | `qxr` | `transformers` | `unicode` |
| `facebook/mms-tts-rah-Rabha` | `rah` | `transformers` | `unicode` |
| `facebook/mms-tts-rai-Ramoaaina` | `rai` | `transformers` | `unicode` |
| `facebook/mms-tts-rap-Rapa Nui` | `rap` | `transformers` | `unicode` |
| `facebook/mms-tts-rav-Sampang` | `rav` | `transformers` | `unicode` |
| `facebook/mms-tts-raw-Rawang` | `raw` | `transformers` | `unicode` |
| `facebook/mms-tts-rej-Rejang` | `rej` | `transformers` | `unicode` |
...
| `facebook/mms-tts-sas-Sasak` | `sas` | `transformers` | `unicode` |
| `facebook/mms-tts-sba-Ngambay` | `sba` | `transformers` | `unicode` |
| `facebook/mms-tts-sbd-Samo, Southern` | `sbd` | `transformers` | `unicode` |
| `facebook/mms-tts-sbl-Sambal, Botolan` | `sbl` | `transformers` | `unicode` |
| `facebook/mms-tts-sbp-Sangu` | `sbp` | `transformers` | `unicode` |
| `facebook/mms-tts-sch-Sakachep` | `sch` | `transformers` | `unicode` |
| `facebook/mms-tts-sck-Sadri` | `sck` | `transformers` | `unicode` |
| `facebook/mms-tts-sda-Toraja-Sa’dan` | `sda` | `transformers` | `unicode` |
| `facebook/mms-tts-sea-Semai` | `sea` | `transformers` | `unicode` |
...
| `facebook/mms-tts-shi-Tachelhit` | `shi` | `transformers` | `unicode` |
| `facebook/mms-tts-shk-Shilluk` | `shk` | `transformers` | `unicode` |
| `facebook/mms-tts-shn-Shan` | `shn` | `transformers` | `unicode` |
| `hf_community/NorHsangPha/mms-tts-shn-Shan` | `shn` | `transformers` | `unicode` |
| `facebook/mms-tts-sho-Shanga` | `sho` | `transformers` | `unicode` |
| `facebook/mms-tts-shp-Shipibo-Conibo` | `shp` | `transformers` | `unicode` |
| `facebook/mms-tts-sid-Sidamo` | `sid` | `transformers` | `unicode` |
| `facebook/mms-tts-sig-Paasaal` | `sig` | `transformers` | `unicode` |
| `facebook/mms-tts-sil-Sisaala, Tumulung` | `sil` | `transformers` | `unicode` |
| `facebook/mms-tts-sja-Epena` | `sja` | `transformers` | `unicode` |
| `facebook/mms-tts-sjm-Mapun` | `sjm` | `transformers` | `unicode` |
...
| `facebook/mms-tts-srn-Sranan Tongo` | `srn` | `transformers` | `unicode` |
...
| `facebook/mms-tts-tbk-Tagbanwa, Calamian` | `tbk` | `transformers` | `unicode` |
| `facebook/mms-tts-tbl-Tboli` | `tbl` | `transformers` | `unicode` |
| `facebook/mms-tts-tby-Tabaru` | `tby` | `transformers` | `unicode` |
| `facebook/mms-tts-tbz-Ditammari` | `tbz` | `transformers` | `unicode` |
| `facebook/mms-tts-tca-Ticuna` | `tca` | `transformers` | `unicode` |
| `facebook/mms-tts-tcc-Datooga` | `tcc` | `transformers` | `unicode` |
| `facebook/mms-tts-tcs-Torres Strait Creole` | `tcs` | `transformers` | `unicode` |
...
| `facebook/mms-tts-tes-Tengger` | `tes` | `transformers` | `unicode` |
...
| `facebook/mms-tts-tly-Talysh` | `tly` | `transformers` | `unicode` |
| `facebook/mms-tts-tmc-Tumak` | `tmc` | `transformers` | `unicode` |
| `facebook/mms-tts-tmf-Toba-Maskoy` | `tmf` | `transformers` | `unicode` |
| `mimic3/tn_ZA/google-nwu_low` | `tn-ZA` | `mimic3` | `espeak` |
| `facebook/mms-tts-tna-Tacana` | `tna` | `transformers` | `unicode` |
| `facebook/mms-tts-tng-Tobanga` | `tng` | `transformers` | `unicode` |
| `facebook/mms-tts-tnk-Kwamera` | `tnk` | `transformers` | `unicode` |
| `facebook/mms-tts-tnn-Tanna, North` | `tnn` | `transformers` | `unicode` |
| `facebook/mms-tts-tnp-Whitesands` | `tnp` | `transformers` | `unicode` |
| `facebook/mms-tts-tnr-Ménik` | `tnr` | `transformers` | `unicode` |
| `facebook/mms-tts-tnt-Tontemboan` | `tnt` | `transformers` | `unicode` |
| `facebook/mms-tts-tob-Toba` | `tob` | `transformers` | `unicode` |
| `facebook/mms-tts-toc-Totonac, Coyutla` | `toc` | `transformers` | `unicode` |
| `facebook/mms-tts-toh-Tonga` | `toh` | `transformers` | `unicode` |
| `facebook/mms-tts-tom-Tombulu` | `tom` | `transformers` | `unicode` |
| `facebook/mms-tts-tos-Totonac, Highland` | `tos` | `transformers` | `unicode` |
| `facebook/mms-tts-tpi-Tok Pisin` | `tpi` | `transformers` | `unicode` |
...
| `facebook/mms-tts-trc-Triqui, Copala` | `trc` | `transformers` | `unicode` |
...
| `facebook/mms-tts-twu-Termanu` | `twu` | `transformers` | `unicode` |
| `facebook/mms-tts-txa-Tombonuo` | `txa` | `transformers` | `unicode` |
...
| `facebook/mms-tts-way-Wayana` | `way` | `transformers` | `unicode` |
| `facebook/mms-tts-wba-Warao` | `wba` | `transformers` | `unicode` |
| `facebook/mms-tts-wlo-Wolio` | `wlo` | `transformers` | `unicode` |
| `facebook/mms-tts-wlx-Wali` | `wlx` | `transformers` | `unicode` |
| `facebook/mms-tts-wmw-Mwani` | `wmw` | `transformers` | `unicode` |
| `facebook/mms-tts-wob-Wè Northern` | `wob` | `transformers` | `unicode` |
| `facebook/mms-tts-wsg-Gondi, Adilabad` | `wsg` | `transformers` | `unicode` |
| `facebook/mms-tts-wwa-Waama` | `wwa` | `transformers` | `unicode` |
| `facebook/mms-tts-xal-Kalmyk-Oirat` | `xal` | `transformers` | `unicode` |
| `facebook/mms-tts-xdy-Malayic Dayak` | `xdy` | `transformers` | `unicode` |
| `facebook/mms-tts-xed-Hdi` | `xed` | `transformers` | `unicode` |
| `facebook/mms-tts-xer-Xerénte` | `xer` | `transformers` | `unicode` |
| `facebook/mms-tts-xmm-Malay, Manado` | `xmm` | `transformers` | `unicode` |
| `facebook/mms-tts-xnj-Chingoni` | `xnj` | `transformers` | `unicode` |
| `facebook/mms-tts-xnr-Kangri` | `xnr` | `transformers` | `unicode` |
| `facebook/mms-tts-xog-Soga` | `xog` | `transformers` | `unicode` |
| `facebook/mms-tts-xon-Konkomba` | `xon` | `transformers` | `unicode` |
| `facebook/mms-tts-xrb-Karaboro, Eastern` | `xrb` | `transformers` | `unicode` |
| `facebook/mms-tts-xsb-Sambal` | `xsb` | `transformers` | `unicode` |
| `facebook/mms-tts-xsm-Kasem` | `xsm` | `transformers` | `unicode` |
| `facebook/mms-tts-xsr-Sherpa` | `xsr` | `transformers` | `unicode` |
| `facebook/mms-tts-xsu-Sanumá` | `xsu` | `transformers` | `unicode` |
| `facebook/mms-tts-xta-Mixtec, Alcozauca` | `xta` | `transformers` | `unicode` |
| `facebook/mms-tts-xtd-Mixtec, Diuxi-Tilantongo` | `xtd` | `transformers` | `unicode` |
| `facebook/mms-tts-xte-Ketengban` | `xte` | `transformers` | `unicode` |
| `facebook/mms-tts-xtm-Mixtec, Magdalena Peñasco` | `xtm` | `transformers` | `unicode` |
| `facebook/mms-tts-xtn-Mixtec, Northern Tlaxiaco` | `xtn` | `transformers` | `unicode` |
| `facebook/mms-tts-xua-Kurumba, Alu` | `xua` | `transformers` | `unicode` |
| `facebook/mms-tts-xuo-Kuo` | `xuo` | `transformers` | `unicode` |
| `facebook/mms-tts-yaa-Yaminahua` | `yaa` | `transformers` | `unicode` |
| `facebook/mms-tts-yad-Yagua` | `yad` | `transformers` | `unicode` |
| `facebook/mms-tts-yal-Yalunka` | `yal` | `transformers` | `unicode` |
| `facebook/mms-tts-yam-Yamba` | `yam` | `transformers` | `unicode` |
| `facebook/mms-tts-yao-Yao` | `yao` | `transformers` | `unicode` |
| `facebook/mms-tts-yas-Nugunu` | `yas` | `transformers` | `unicode` |
| `facebook/mms-tts-yat-Yambeta` | `yat` | `transformers` | `unicode` |
| `facebook/mms-tts-yaz-Lokaa` | `yaz` | `transformers` | `unicode` |
| `facebook/mms-tts-yba-Yala` | `yba` | `transformers` | `unicode` |
| `facebook/mms-tts-ybb-Yemba` | `ybb` | `transformers` | `unicode` |
| `facebook/mms-tts-ycl-Lolopo` | `ycl` | `transformers` | `unicode` |
| `facebook/mms-tts-ycn-Yucuna` | `ycn` | `transformers` | `unicode` |
...
| `facebook/mms-tts-yva-Yawa` | `yva` | `transformers` | `unicode` |
| `facebook/mms-tts-zaa-Zapotec, Sierra de Juárez` | `zaa` | `transformers` | `unicode` |
| `facebook/mms-tts-zab-Zapotec, Western Tlacolula Valley` | `zab` | `transformers` | `unicode` |
| `facebook/mms-tts-zac-Zapotec, Ocotlán` | `zac` | `transformers` | `unicode` |
| `facebook/mms-tts-zad-Zapotec, Cajonos` | `zad` | `transformers` | `unicode` |
| `facebook/mms-tts-zae-Zapotec, Yareni` | `zae` | `transformers` | `unicode` |
| `facebook/mms-tts-zai-Zapotec, Isthmus` | `zai` | `transformers` | `unicode` |
| `facebook/mms-tts-zam-Zapotec, Miahuatlán` | `zam` | `transformers` | `unicode` |
| `facebook/mms-tts-zao-Zapotec, Ozolotepec` | `zao` | `transformers` | `unicode` |
| `facebook/mms-tts-zaq-Zapotec, Aloápam` | `zaq` | `transformers` | `unicode` |
| `facebook/mms-tts-zar-Zapotec, Rincón` | `zar` | `transformers` | `unicode` |
| `facebook/mms-tts-zas-Zapotec, Santo Domingo Albarradas` | `zas` | `transformers` | `unicode` |
| `facebook/mms-tts-zav-Zapotec, Yatzachi` | `zav` | `transformers` | `unicode` |
| `facebook/mms-tts-zaw-Zapotec, Mitla` | `zaw` | `transformers` | `unicode` |
| `facebook/mms-tts-zca-Zapotec, Coatecas Altas` | `zca` | `transformers` | `unicode` |
| `facebook/mms-tts-zga-Kinga` | `zga` | `transformers` | `unicode` |
| `hf_community/BricksDisplay/vits-cmn` | `zh-CN` | `transformers` | `unicode` |
...
| `facebook/mms-tts-zim-Mesme` | `zim` | `transformers` | `unicode` |
| `facebook/mms-tts-ziw-Zigula` | `ziw` | `transformers` | `unicode` |
| `facebook/mms-tts-zlm-Malay` | `zlm` | `transformers` | `unicode` |
| `facebook/mms-tts-zmz-Mbandja` | `zmz` | `transformers` | `unicode` |
| `facebook/mms-tts-zne-Zande` | `zne` | `transformers` | `unicode` |
| `facebook/mms-tts-zos-Zoque, Francisco León` | `zos` | `transformers` | `unicode` |
| `facebook/mms-tts-zpc-Zapotec, Choapan` | `zpc` | `transformers` | `unicode` |
| `facebook/mms-tts-zpg-Zapotec, Guevea de Humboldt` | `zpg` | `transformers` | `unicode` |
| `facebook/mms-tts-zpi-Zapotec, Santa María Quiegolani` | `zpi` | `transformers` | `unicode` |
| `facebook/mms-tts-zpl-Zapotec, Lachixío` | `zpl` | `transformers` | `unicode` |
| `facebook/mms-tts-zpm-Zapotec, Mixtepec` | `zpm` | `transformers` | `unicode` |
| `facebook/mms-tts-zpo-Zapotec, Amatlán` | `zpo` | `transformers` | `unicode` |
| `facebook/mms-tts-zpt-Zapotec, San Vicente Coatlán` | `zpt` | `transformers` | `unicode` |
| `facebook/mms-tts-zpu-Zapotec, Yalálag` | `zpu` | `transformers` | `unicode` |
| `facebook/mms-tts-zpz-Zapotec, Texmelucan` | `zpz` | `transformers` | `unicode` |
| `facebook/mms-tts-ztq-Zapotec, Quioquitani-Quierí` | `ztq` | `transformers` | `unicode` |
| `facebook/mms-tts-zty-Zapotec, Yatee` | `zty` | `transformers` | `unicode` |
| `facebook/mms-tts-zyb-Zhuang, Yongbei` | `zyb` | `transformers` | `unicode` |
| `facebook/mms-tts-zyp-Chin, Zyphe` | `zyp` | `transformers` | `unicode` |
| `facebook/mms-tts-zza-Zaza` | `zza` | `transformers` | `unicode` |
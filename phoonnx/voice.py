...
class TTSVoice:
    ...
    def phoneme_ids_to_audio(
        ...
        # Forward optional reference / control fields from SynthesisConfig
        for ref_key in ("timbre_ref_path", "artic_ref_path", "prosody_ref_path", "emotion"):
            ref_val = getattr(syn_config, ref_key, None)
            if ref_val is not None:
                params[ref_key] = ref_val
